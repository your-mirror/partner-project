...
use app\modules\managers\models\ManagerSearch;
...
class DefaultController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel  = Yii::createObject(ManagerSearch::className());
    ...
    public function actionCreate()
    {
        ...
        if ($user->load(Yii::$app->request->post()) && $user->create(Yii::$app->user->id)) {
    ...
    public function actionSuperlogin($id)
    {
        $user = $this->findModel($id);
        Yii::$app->user->logout();
